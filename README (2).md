...
- [![Pandas](https://pandas.pydata.org/static/img/pandas_white.svg)](https://pandas.pydata.org/) **Pandas**
- [![NumPy](https://numpy.org/images/logo.svg)](https://numpy.org/) **NumPy**
- [![Scikit-learn](https://scikit-learn.org/stable/_static/scikit-learn-logo-small.png)](https://scikit-learn.org/) **Scikit-learn**
- [![TensorFlow](https://www.tensorflow.org/images/tf_logo_social.png)](https://www.tensorflow.org/) **TensorFlow / Keras**
- [![FastAPI](https://fastapi.tiangolo.com/img/logo-margin/logo-teal.png)](https://fastapi.tiangolo.com/) **FastAPI**
